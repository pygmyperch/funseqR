...
# Test export function after schema fix

library(funseqR)

cat("=== TESTING EXPORT WITH CORRECTED SCHEMA ===\n")

# Connect to source database
con <- connect_funseq_db('simple_funseq_project.db')

# Clean up any previous test database
test_db <- "test_corrected_schema.db"
...
tryCatch({
  # Test export with corrected schema
  ...
  cat("✅ Export function now works with corrected schema\n")
  cat("✅ No more 'Columns not found' errors\n")
